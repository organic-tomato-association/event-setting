  ...
  render() {
    return (
      ...
      >
          ...
          <div className="event-detail">
            <div className="event-detail-data">
              ...
              <div className="event-detail-data-text">
                ...
                <p>Created by {this.props.users.find(user => user.id === this.state.displayEvent.created_by).displayName}</p>
              </div>
            </div>
                ...
                {(() => {
                  if (!!this.state.displayEvent.member.length) {
                    return this.state.displayEvent.member.map(member => (
                      <div
                        key={member}
                        className="event-detail-member-list-item"
                      >
                        {this.props.users.find(user => user.id === member).displayName}
                      </div>
                    ));
                  } else {
        ...
        {
          this.props.uid === this.state.displayEvent.created_by
            ? (
              <div style={{ textAlign: 'center' }}>
                <Button onClick={this.pushPage.bind(this, this.props.event)}>編集</Button>
